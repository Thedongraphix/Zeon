...
Agent: 🚀 Creating fundraiser "Web3 Ladies" with goal of 0.5 ETH...
       ✅ Fundraiser created successfully! [Details and QR code]

You: help
Agent: 🚀 **Zeon Fundraiser Agent Commands**
...
```
├── index.ts                 # Main XMTP agent entry point
├── helpers/
│   └── client.ts            # XMTP and crypto utilities
├── utils/
│   ├── blockchain.ts        # Blockchain utilities
│   ├── fundraiser-contract.ts # Fundraiser contract management
│   └── ...
├── scripts/
...
- Shows typing indicator with "👀" reaction
